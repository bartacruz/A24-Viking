...
# A24-specific interfaces loaded locally, replacing GenericEISPublisher implementation.
# The reason we do this is that this A24 version uses some modified property locations for the EIS display.
var aircraft_dir = getprop("/sim/aircraft-dir");
io.load_nasal(aircraft_dir ~ '/Nasal/EIS/EISPublisher.nas', "fg1000");
io.load_nasal(aircraft_dir ~ '/Nasal/A24-FuelPublisher.nas', "fg1000");
