...
#
# A24 EIS - Copyright 2025 Julio Santa Cruz (Barta)
...
var EIS =
{
  new : func (mfd, myCanvas, device, svg)
  {
    ...
    obj.addTextElements(["PowerDisplay", "RPMDisplay", "ManDisplay", "FuelFlowDisplay", "OilTempDisplay", "OilPressureDisplay", "Batt1Display", "BusDisplay","CHTDisplay","EGTDisplay" ]);

    #obj._PowerPointer = PFD.RotatingElement.new(obj.pageName, svg, "PowerPointer", 0, 1.15, 160, [300,100]);
    obj._PowerPointer = PFD.RotatingElement.new(obj.pageName, svg, "PowerPointer", 0, 1, 160, [300,100]);
    ...
    obj._egtPointer         = PFD.PointerElement.new(obj.pageName, svg, "EGTPointer", 0.0, 400, 135);
    obj._ampBattAPointer     = PFD.PointerElement.new(obj.pageName, svg, "Batt1Pointer", -40, 40, 135);
    obj._EssBusPointer     = PFD.PointerElement.new(obj.pageName, svg, "ESSPointer", 0.0, 30, 135);
    obj._leftFuelPointer     = PFD.PointerElement.new(obj.pageName, svg, "LeftFuelPointer", 0.0, 35, 135);
    obj._rightFuelPointer     = PFD.PointerElement.new(obj.pageName, svg, "RightFuelPointer", 0.0, 35, 135);
...
#    me.setTextElement("MBusVolts", sprintf("%.01f", engineData.MBusVolts));
    me.setTextElement("Batt1Display", sprintf("%.02f", engineData.MBattAmps));
    me.setTextElement("BusDisplay", sprintf("%.02f", engineData.MBusVolts));
    ...
    me._egtPointer.setValue(engineData.EGTDegF);
    me._ampBattAPointer.setValue(engineData.MBattAmps);
